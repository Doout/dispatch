...
import {
  DeploymentRuntime,
  ServerRuntime,
} from "./deployments/RuntimeTopology";
import {
  buildDeploymentRails,
  DeploymentFocusRails,
} from "./deployments/DeploymentFocusRail";
...
function canDeleteResource(overview: Overview, target: DeleteTarget) {
