...
export function ObservationSettings({ application, overview, refreshToken = 0, onChecked }: { application: App; overview: Overview; refreshToken?: number; onChecked?: () => void }) {
