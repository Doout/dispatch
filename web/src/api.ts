...
export const api = {
  ...
  deleteEventTrigger: (id: string) => request<void>(`/api/v1/event-triggers/${id}`, { method: "DELETE" }),
	...
	startLanewayNetworkAuthorization: (body: { name: string; authority: string }) => request<{ authorizationUrl: string }>("/api/v1/laneway-networks/authorize", { method: "POST", body: JSON.stringify(body) }),
